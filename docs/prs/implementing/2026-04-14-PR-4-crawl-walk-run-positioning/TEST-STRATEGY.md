...
| T11 | README.md | Links to sibling scaffolds | AC5 | grep "ai-native-dev-scaffold-run" (non-compound) |
...
- [ ] CI docs-gate green
- [ ] Sibling PR #8 in `ai-native-dev-scaffold-run` merged first (recommended, not blocking)
