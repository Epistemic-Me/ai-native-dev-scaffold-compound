...
3. **Execute upon confirmation:**
   ...
   - Never commit documentation-only directories (e.g., `docs/research/`, `docs/plans/`) unless explicitly asked
...
- **IMPORTANT**: Never stop and ask for feedback from the user - just execute
