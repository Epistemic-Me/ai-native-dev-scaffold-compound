...
1. **If a handoff document path was provided**:
   ...
   - Immediately read any plan or research documents it links to
...
Tip: List recent handoffs with `ls -lt docs/handoffs/ | head`
```
...
2. **Spawn focused research tasks**:
   ...
   - Verify code state matches handoff description
